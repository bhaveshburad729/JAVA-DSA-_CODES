 ...
 * 
 * When we reach the last row (row == n), it means all Queens are placed
 * successfully → print the board.
 * 
 * Safety Check (isSafe)
 ...
 * 
 * Right Diagonal Check: Look upward-right diagonal. If a Queen exists, not
 * safe.
 * 
 ...
 * Backtracking
 * 
 * If a Queen is placed and further recursion fails to find a solution, remove
 * that Queen ('x') and try another column.
 * 
 ...
 * 
 * If no valid position found in a later row → backtrack to previous row, remove
 * Queen, and try a new position.
 * 
